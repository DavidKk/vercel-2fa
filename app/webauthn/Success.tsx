  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center p-4 bg-gray-100">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
        ...
        <p className="text-sm text-gray-500 mb-6 text-center">Your WebAuthn credentials has been successfully registered. You can now use this device for authentication.</p>
